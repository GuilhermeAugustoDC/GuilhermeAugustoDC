...
Sou desenvolvedor web voltado para soluções modernas: APIs, microserviços e automação inteligente. Este espaço é dedicado à minha evolução como desenvolvedor, sempre buscando excelência técnica e entrega de valor.
...
- **Documentação clara:** Oriento meu trabalho por boas práticas de documentação e organização.
- **Automação que gera impacto:** Scripts, bots ou integrações para reduzir erros e aumentar produtividade.
- **Colaboração (Open Source):** Engajado, participo de comunidades e projetos abertos.
- **Adaptabilidade:** Aprendo rápido e busco novas ferramentas sem medo de mudanças.

---

## 💡 Projetos em Destaque

- **APIs REST e GraphQL:** Serviços web robustos para diferentes cenários de negócio.
- **Automação:** Bots para tarefas recorrentes e integrações entre sistemas.
- **Microserviços:** Arquitetura voltada para escalabilidade e agilidade.
...
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-blue?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/gaddc/S)
[![Email](https://img.shields.io/badge/-Email-red?logo=gmail&logoColor=white)](mailto:guiidiasdc@gmail.com)
...
Estou aberto para parcerias, projetos inovadores e aprendizados compartilhados.
